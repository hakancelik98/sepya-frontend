...
export default function ShippingForm({
    ...
    /*
       DEĞİŞİKLİK BURADA:
       text-sm (14px) olan mobil font boyutu, tarayıcıların zoom tetiklemesini
       engellemek için varsayılan olarak text-base (16px) yapıldı.
       Masaüstünde ise görsel uyum için md:text-sm veya md:text-base olarak kalabilir.
    */
    const inputStyle =
        "w-full border border-gray-200 rounded-xl md:rounded-xl outline-none px-3 md:px-4 py-2.5 md:py-2 text-base md:text-sm focus:border-black focus:ring-2 focus:ring-black/5 transition-all bg-white text-gray-900 font-medium placeholder:text-gray-400";
