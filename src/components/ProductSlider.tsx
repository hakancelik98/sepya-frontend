...
export default function AdaStyleSlider() {
    ...
    const scroll = (direction: 'left' | 'right') => {
        ...
        setTimeout(() => { isMoving.current = false; }, 400);
    };
    ...
    return (
        <section className="py-12 bg-white select-none overflow-hidden">
            <div className="w-full max-w-[1536px] mx-auto px-0 md:px-6 relative group">
                ...
                <button
                    onClick={() => scroll('left')}
                    className="hidden md:flex absolute left-4 top-[45%] z-20 w-11 h-11 items-center justify-center bg-white border border-gray-200 rounded-full shadow-sm opacity-0 group-hover:opacity-100 transition-all hover:bg-black hover:text-white"
                >
                    <ChevronLeft size={20} strokeWidth={1} />
                </button>
                <button
                    onClick={() => scroll('right')}
                    className="hidden md:flex absolute right-4 top-[45%] z-20 w-11 h-11 items-center justify-center bg-white border border-gray-200 rounded-full shadow-sm opacity-0 group-hover:opacity-100 transition-all hover:bg-black hover:text-white"
                >
                ...
                <div
                    ...
                    className="flex overflow-x-auto gap-[2px] md:gap-6 pb-4 snap-x snap-mandatory scroll-smooth overscroll-x-contain"
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="mt-3 text-center px-2">
                                    ...
                                    <Link href={href}>
                                        <h3 className="text-[11px] md:text-[12px] font-normal tracking-wider uppercase text-gray-700 line-clamp-1 leading-tight mb-1 hover:text-black transition-colors">
                                            {item.title}
                                        </h3>
                                    </Link>
