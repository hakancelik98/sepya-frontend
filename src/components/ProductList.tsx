...
import { Search, Edit2, Trash2, Copy, Image as ImageIcon, Tag, Palette, Ruler, Box, Sparkles, Layers, Star } from "lucide-react";

export default function ProductList({ filteredProducts, handleEdit, handleDelete, handleDuplicate, setSearchTerm, handleToggleCampaign }: any) {
    return (
            ...
            <div className="flex-1 overflow-auto scrollbar-thin">
                <table className="w-full border-collapse min-w-[1400px]">
                    ...
                    <tr className="text-[9px] font-black text-slate-900 uppercase tracking-[0.1em] text-left">
                        ...
                        <th className="px-4 py-4 w-24"><div className="flex items-center gap-1"><Star size={10}/> Kampanya</div></th>
                    ...
                    {filteredProducts && filteredProducts.length > 0 ? (
                        ...
                        <tr>
                            <td colSpan={13} className="px-4 py-8 text-center text-slate-400">
                                <span className="text-[12px] font-bold">Ürün bulunamadı</span>
                            </td>
                        </tr>
                    )}
                    </tbody>
